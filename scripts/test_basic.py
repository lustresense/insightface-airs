...
def test_database_init():
    ...
    try:
from app import app import db_connect, db_init
        db_init()
...
def test_cascade_classifiers():
    ...
    try:
from app import app import detectors
        count = len(detectors)
        if count > 0:
...
def test_recognizer():
    ...
    print("\nTest 5: Recognizer...")
    try:
from app import app import recognizer, FACE_ENGINE
...
def test_directories():
    ...
    try:
from app import app import DATA_DIR, MODEL_DIR
        dirs = {
            'DATA_DIR': DATA_DIR,
            'MODEL_DIR': MODEL_DIR
        }
...
def test_preprocessing_function():
    ...
    try:
        import cv2
        import numpy as np
from app import app import preprocess_roi
...
def test_file_naming():
    ...
    try:
from app import app import list_existing_samples
