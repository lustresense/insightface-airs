...
def test_data_dir_consistency():
    ...
    try:
from app import app import DATA_DIR, BASE_DIR
...
def test_preprocessing_consistency():
    ...
    try:
from app import app import preprocess_roi, save_face_images_from_frame, DATA_DIR
        import glob
...
def test_blur_threshold():
    ...
    try:
from app import app import is_blurry
from app import face_engine
...
def test_file_naming_format():
    ...
    try:
from app import app import DATA_DIR
        import glob
